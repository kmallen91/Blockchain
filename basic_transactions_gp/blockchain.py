...
def receive_transaction():
    ...
    response = {
        'message': f'User created. Transaction will be added to block at {index}'
    }
    ...
    #             users[user_id].value - amount
    #             users[recipient].value + amount
    #             response = {
    #                 'message': f'Money sent! Transaction added to block {index}'
    #             }
    #             return jsonify(response), 201
    #         else:
    #             users[recipient] = amount
    #     response = {
    #         'message': f'Transaction will be added to block at {index}'
    #     }
    #     users[user_id].value + amount
    #     return jsonify(response), 201
    # else:
...
def mine():
    ...
    new_hash = blockchain.valid_proof(string_block, proof)
